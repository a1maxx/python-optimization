...
if __name__ == "__main__":
    TASKS = {
        ...
        ('Task_1', 'Server_1'): {'dur': int(round(25 * 1, 0)), 'prec': None, 'pri': 2},
        ('Task_1', 'Server_2'): {'dur': int(round(10 * 1, 0)), 'prec': ('Task_1', 'Server_1'), 'pri': 2},
        ('Task_2', 'Server_1'): {'dur': int(round(10 * 1, 0)), 'prec': None, 'pri': 3},
        ('Task_2', 'Server_2'): {'dur': int(round(20 * 1, 0)), 'prec': ('Task_2', 'Server_1'), 'pri': 3},
        ('Task_2', 'Server_3'): {'dur': int(round(12 * 1, 0)), 'prec': ('Task_2', 'Server_2'), 'pri': 3},
        ('Task_3', 'Server_2'): {'dur': int(round(12 * 1, 0)), 'prec': ('Task_3', 'Server_3'), 'pri': 5},
        ('Task_3', 'Server_3'): {'dur': int(round(28 * 1, 0)), 'prec': None, 'pri': 5},
        ('Task_3', 'Server_2'): {'dur': int(round(12 * 1, 0)), 'prec': ('Task_3', 'Server_3'), 'pri': 5},
        ("Task_4", "Server_1"): {'dur': int(round(12 * 1, 0)), 'prec': None, 'pri': 2},
        ("Task_4", "Server_2"): {'dur': int(round(19 * 1, 0)), 'prec': ('Task_4', 'Server_1'), 'pri': 2},
